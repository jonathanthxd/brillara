...
export default function AdvisorDashboard() {
  ...
  const activeMyTickets = useMemo(() => myTickets.filter((ticket) => !["compra-realizada", "no-concretado", "cancelado", "archivado"].includes(ticket.status)), [myTickets]);
  const closedMyTickets = useMemo(() => myTickets.filter((ticket) => ["compra-realizada", "no-concretado", "cancelado", "archivado"].includes(ticket.status)), [myTickets]);
